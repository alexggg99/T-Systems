...
public class BuyTicketServlet extends HttpServlet {
    ...
    private static final Logger logger = Logger.getLogger("DEBUG_LOGGER");
...
//                }
                ...
                if (!ticketService.isMoreTh10min(targetRouteEntity.getRouteEntity_id())) {
                    request.getSession().setAttribute("isEnoughTickets", "true");
                    request.getSession().setAttribute("isPassengerOnTrain", "true");
                ...
                if (ticketService.isEnoughTicketsOnTrain(targetRouteEntity.getRoute())
                        && !ticketService.isPassengerOnTrain(targetRouteEntity.getRoute(), pass)
                        && ticketService.isMoreTh10min(targetRouteEntity.getRouteEntity_id())) {
