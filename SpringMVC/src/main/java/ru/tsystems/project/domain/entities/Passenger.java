...
@NamedQueries({
    ...
    @NamedQuery(name = Passenger.GETPASSENGERS, query = "Select DISTINCT tc.passenger from Ticket tc join tc.route r where r.routeId = :routeId"),
...
public class Passenger implements Serializable {
    ...
    public static final String GETPASSENGERS = "Passenger.findPassengers";
    ...
    public boolean equals(Object obj) {
        ...
        if (this.birthday.compareTo(other.birthday)==0 && this.firstName.equalsIgnoreCase(other.firstName)
